...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  OrderStateStus get status {
    _$_statusAtom.reportRead();
    return super._status;
  }

  @override
  OrderStateStus get _status => status;

  @override
  set _status(OrderStateStus value) {
  ...
  @override
  Future<void> showDetailModel(OrderModel order) {
    return _$showDetailModelAsyncAction.run(() => super.showDetailModel(order));
  }
