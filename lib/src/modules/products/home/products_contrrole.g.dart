...
part of 'products_contrrole.dart';
...
mixin _$ProductsContrrole on ProductsContrroleBase, Store {
  late final _$_statusAtom =
      Atom(name: 'ProductsContrroleBase._status', context: context);
  ...
  late final _$_productsAtom =
      Atom(name: 'ProductsContrroleBase._products', context: context);
  ...
  late final _$_filterNameAtom =
      Atom(name: 'ProductsContrroleBase._filterName', context: context);
  ...
  late final _$_productSelectedAtom =
      Atom(name: 'ProductsContrroleBase._productSelected', context: context);
  ...
  late final _$filterByNameAsyncAction =
      AsyncAction('ProductsContrroleBase.filterByName', context: context);
  ...
  late final _$loadProductsAsyncAction =
      AsyncAction('ProductsContrroleBase.loadProducts', context: context);
  ...
  late final _$addProductAsyncAction =
      AsyncAction('ProductsContrroleBase.addProduct', context: context);
  ...
  late final _$editProductAsyncAction =
      AsyncAction('ProductsContrroleBase.editProduct', context: context);
